...
const ModalDelete = ({setIsDelete,queryKey,mysqlApiDelete}) => {
...
<ModalWrapper>
        <div className="modal-main bg-primary z-50 max-w-[350px] w-full rounded-md">
            <div className="modal-header p-2 border-bottom border-line flex justify-between items-center">
                <h3 className='leading-none mb-0 text-alert'>Delete</h3>
                <button onClick={handleClose}><X/></button>
            </div>

            <div className="modal-body p-2 px-4 text-center">
                <div className='size-[40px] mt-2 bg-alert bg-opacity-30 grid place-content-center rounded-full mx-auto'>
            ...
            <div className='modal-footer flex px-4 py-2 border-t border-line justify-end gap-3'>
