    ...
    const mutation = useMutation({
      ...
      onSuccess: (data) => {
        ...
        if (data.success) {
          ...
          disptach(setMessage(data.error));
          // dispatch(setSuccess(true));
  ...
  return (
   <ModalWrapper>
    <Formik
        ...
        <div className='modal-header px-4 p-3 flex justify-between items-center mb-0 pb-0'> 
            <h3>Add Movie</h3>
        ...
        <div className='modal-action flex justify-end gap-3 p-3 px-4 items-center pb-0'>
