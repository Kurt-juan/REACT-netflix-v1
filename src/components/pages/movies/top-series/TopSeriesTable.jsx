           ...
           {error && (
            ...
            {result?.data.map((item,key ) => {
                ...
                return(
                    ...
                    <td><Pill isActive = {item.topseries_is_active}/></td>
                    <td>
...
{isAdd && <TopSeriesModalAdd setIsAdd={setIsAdd} setIsSuccess={setIsSuccess} itemEdit={itemEdit} setIsValidate={setIsValidate} setMessage={setMessage} />}
