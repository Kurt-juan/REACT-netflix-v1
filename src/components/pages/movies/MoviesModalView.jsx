        ...
        <ModalWrapper>
            <div className="modal-main z-50 max-w-[600px] w-full rounded-md overflow-hidden">
                <div className="movie-thumbnail relative ">
                    <img src={`${devImgPath}/${itemEdit.movies_image}`} alt="" className='w-full h-auto lg:h-[330px] aspect-video object-cover' />
                    ...
                    <h2 className='absolute left-3 bottom-3'>{itemEdit.movies_title}</h2>
                ...
                <div className='movie-info p-4 bg-secondary  '>
                        ...
                        <button className='font-semibold flex gap-3 bg-white text-black px-2 py-1.5 rounded-md mb-2 justify-center items-center w-full hover:opacity-80 trasition-all'><Play size={14} fill={"#000"}/>Play</button>
                       
                        <button className='flex gap-3 bg-primary px-2 py-1.5 rounded-md mb-5 justify-center items-center w-full hover:opacity-80 trasition-all '><Download size={14}/>Download</button>
